    ...
    return(
        ...
        <section className={Styles.fundo_home}>
            ...
            <div className={Styles.texto_home}>
                ...
                <p>Realize seus sonhos e explore o mundo com a gente. Oferecemos pacotes completos e 
                    personalizados para os destinos mais incríveis, garantindo que sua próxima aventura 
                    seja inesquecível e planejada sob medida.</p>
            </div>
        </section>
